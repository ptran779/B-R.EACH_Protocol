...
public abstract class AbsAgentStruct extends Mob implements IEntityTeamNTarget, IEntityRender {
  private UUID bossUUID;
  public int charge = 0;  // for engineer to use

  public AbsAgentStruct(EntityType<? extends Mob> pEntityType, Level pLevel) {
	...
	public static AttributeSupplier.Builder createAttributes() {
		return Mob.createLivingAttributes()
			...
			.add(Attributes.ARMOR, 10.0)         // 5 armor bars, reduces damage ~30%
			.add(Attributes.ARMOR_TOUGHNESS, 4.0) // reduces armor penetration
			.add(Attributes.KNOCKBACK_RESISTANCE, 1.0); // immune to knockback, it's bolted down
	}
