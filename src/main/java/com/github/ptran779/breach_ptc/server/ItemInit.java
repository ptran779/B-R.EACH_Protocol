...
public final class ItemInit {
	...
	public static final RegistryObject<Item> BANDAGE_ITEM =
		ITEMS.register("bandage", () -> new BandageItem(new Item.Properties()));
	public static final RegistryObject<Item> MORPHINE_ITEM =
	...
	public static final RegistryObject<Item> PATROL_LIST_ITEM =
		ITEMS.register("patrol_list", () -> new PatrolList(new Item.Properties().stacksTo(64)));


	public static final RegistryObject<Item> THE_GREAT_DEBUG_STICK_ITEM =
		ITEMS.register("the_great_debug_stick", () -> new TheGreatDebugStick(new Item.Properties().stacksTo(1)));
}
